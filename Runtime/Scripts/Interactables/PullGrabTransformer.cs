...
namespace UnityEngine.XR.Interaction.Toolkit.Transformers
{
    ...
    [BurstCompile]
#endif
    public class PullGrabTransformer : XRBaseGrabTransformer
    {
        /// <summary>
        ...
        protected void Awake()
        {
            ...
            m_PullState = GetComponent<PullState>();
        }
        ...
        private Vector3 AdjustPositionForPermittedAxes(in Vector3 targetPosition, in Pose originalObjectPose, ManipulationAxes permittedAxes, ConstrainedAxisDisplacementMode axisDisplacementMode)
        {
        ...
        [BurstCompile]
#endif
        private void AdjustPositionForPermittedAxesBurst(in Vector3 targetPosition, in Pose originalObjectPose, ConstrainedAxisDisplacementMode axisDisplacementMode, bool hasX, bool hasY, bool hasZ, out Vector3 adjustedTargetPosition)
        {
            ...
            var adjustedPosition = originalObjectPosition + sumTranslationVector;
            adjustedTargetPosition = m_PullState.ClampPoint(adjustedPosition);
        }
